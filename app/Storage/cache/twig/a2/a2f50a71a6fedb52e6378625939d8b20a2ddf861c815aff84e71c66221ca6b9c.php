...
class __TwigTemplate_ba099f097f4e065f714427c94abc2ea916bcdc8792787a5fb6a30d2ba9cb0069 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("app/layout.html.twig", "app/configuration.html.twig", 1);
...
";
    ...
    {
        return array (  144 => 62,  140 => 61,  94 => 18,  88 => 14,  77 => 12,  73 => 11,  70 => 10,  59 => 8,  55 => 7,  50 => 4,  46 => 3,  35 => 1,);
    }
        ...
        <div id=\"liste\">
            <ul>
                {% for etudiant in etudiants %}
                    <li> {{etudiant.nom}} {{etudiant.pnom}}<i class=\"las la-times\"></i> <i class=\"las la-pen\"></i></li>
                {% endfor %}

                {% for equipe in equipes %}
                    <li> {{equipe.nom}} {{equipe.pnom}}<i class=\"las la-times\"></i> <i class=\"las la-pen\"></i></li>
                {% endfor %}
...
{% endblock %}", "app/configuration.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/ptutMVC-1/app/Views/app/configuration.html.twig");
    }
}
