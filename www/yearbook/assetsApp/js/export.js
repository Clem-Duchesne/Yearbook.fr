$(document).ready(function () {
    ...
    exportBtn.click(function () {
        ...
        for (let i = 0; i < polices.length; i++) {
            doc.addFont(
                polices[i].children[0].innerText,
                polices[i].children[1].innerText,
                "normal"
            );
        }
                ...
                if (n > 0) {
                    ...
                    for (let j = 0; j < n; j++) {
                        ...
                        doc.addImage(
                            img,
                            "JPG",
                            dimensionPosition[j][0],
                            dimensionPosition[j][1],
                            dimensionPosition[j][2],
                            dimensionPosition[j][3]
                        );
                        //Définition des bordures autour de l'image
                        doc.setDrawColor(255, 255, 255);
                        doc.setLineWidth(4);
                        doc.line(
                            dimensionPosition[j][0] - 1,
                            dimensionPosition[j][1],
                            dimensionPosition[j][0] +
                                dimensionPosition[j][2] +
                                3,
                        ...
                        doc.line(
                            ...
                            dimensionPosition[j][1],
                            dimensionPosition[j][0] + 1,
                            dimensionPosition[j][3] + dimensionPosition[j][1]
                        );
                        doc.line(
                            dimensionPosition[j][0] +
                                dimensionPosition[j][2] +
        ...
        window.setTimeout(function () {
            ...
            window.location.href =
                "http://localhost/ptut/ptutYB/yearbook/www/yearbook/app/export/export";
        }, 3000);
    });
});
